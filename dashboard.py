...
<div class="qa-page" id="qa-shared-page">
  <div class="qa-g3">
    ...
    <div class="qa-card">
      ...
      <div class="qa-cbody" style="padding:10px 14px;display:flex;flex-direction:column">
        <div style="position:relative;flex:1;min-height:140px"><canvas id="qa-donut-chart"></canvas></div>
